 ...
 */
public class Model98581 extends MicModel{

    public static String ID = "98581";
    ...
    public byte[] parseCommand(byte[] cmd) {
        ...
        switch(cmd[0]){
            case 'I':
                ...
                break;
            case 'M':
                b = hexStringToByteArray("6d20332031204d206230332064653720310d");
                break;
            case 'Q':
                b = hexStringToByteArray("3e0d");
                break;
            case 'D':
                b = hexStringToByteArray("64203234320d64203234320d64203234320d");
                break;
        }
